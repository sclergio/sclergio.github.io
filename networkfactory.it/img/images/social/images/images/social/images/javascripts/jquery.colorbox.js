...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Designova | Premium Web Design and Theme Development Studio</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">  
    <meta name="description" content="Designova - Premium Web Design and Theme Development Studio. Responsive Web Designing with HTML5, CSS3, jQuery animations. Premium Web Templates and WordPress Themes. Mobile Site Development" />
    <meta name="author" content="Designova" />
    <meta name="copyright" content="Designova Copyright (c) 2013" />
    <meta name="keywords" content="designova, responsive web design, premium web templates, wordpress themes, html5, web devlopment, jquery animations, css3, jQuery, parallax, minimalist website, interactive html5, animated html5 websites, web design india, donehost, pixelglimpse, designova.com, affordable web development, foundation, designovastudio, Designova Webtech, designova network, Designova,  outsource to india" />
        ...
        <section class="container">
            <div class="welcome row">
                <article class="span12">
                    <h1 class="text-left promo-caps error404">404</h1>
                </article>
            </div><!--/ row-->
            <div class="welcome row">
                <article class="span12">
                    <p class="text-right promo-text">The page your are looking for is <span>not found</span> on this site.</p>
                </article>
            </div><!--/ row-->
...
<section class="container-fluid address-wrap">
    <div class="row-fluid">
        <section class="container">
            ...
            <div class="row">
                <article id="link-block" class="span6">
                    <h3>Made with love at Kerala</h3>
                    <a href="../../../../../../../../../www.mediatemple.net/#a_aid=4f1ff6e5b3912/default.htm" target="_blank"><img src="images/mt2.jpg"/></a>
                    <ul>
                        <li><a href="privacy.html">Privacy Policy</a></li>
                        <li><a href="terms.html">Terms of Service</a></li>
                    </ul>
                </article>
                <article id="address-block" class="span6">
                    <h2>designova</h2>
                    <h3>ArrowsMedia Holdings IN.<br/>Round N, Thrissur 2<br/>Kerala, IN</h3>
                    <h5><span>Copyright &copy; 2013 Designova</span></h5>
                </article>
...
<footer id="mastfoot">
    ...
    <div class="row-fluid">
        <section class="container">
            ...
            <div class="row">
                <article class="span4">
                    <a href="../../../../../../../../../www.twitter.com/designovastudio" target="_blank"><h3 class="text-left twitter-user">@designovastudio</h3></a>
                </article>
                <nav class="span8 foot-social">
                        <a href="../../../../../../../../../https@www.facebook.com/designovanetwork" target="_blank"><img title="live" alt="live" src="images/social/02.png"></a>
                        <a href="../../../../../../../../../in.linkedin.com/company/designova" target="_blank"><img title="live" alt="live" src="images/social/04.png"></a>
                        <a href="../../../../../../../../../pinterest.com/designovastudio/default.htm" target="_blank" ><img title="live" alt="live" src="images/social/05.png"></a>
                        <a href="../../../../../../../../../www.twitter.com/designovastudio" target="_blank"><img title="live" alt="live" src="images/social/07.png"></a>
                </nav>
            </div><!--/ row-->
